...
// TODO: or figure out where this file comes from and set it to that on the content server
	...
	ri.Printf(PRINT_ALL, "GLIMP: Destroying existing context.\n");
	...
	for (i = 0; i < 16; i++)
	{
	  ...
	  // If not allowing software GL, demand accelerated
		...
		ri.Printf(PRINT_ALL, "GLIMP: Creating window.\n");
		...
		ri.Printf(PRINT_ALL, "GLIMP: Creating context.\n");
...
*/
		...
		ri.Printf(PRINT_ALL, "GLIMP: Setting colors.\n");
...
===============
*/
qboolean GLimp_StartDriverAndSetMode(int mode, qboolean fullscreen, qboolean noborder, qboolean gl3Core)
{
	rserr_t err;
...
{
	ri.Printf(PRINT_ALL, "Glimp_Init( %i )\n", fixedFunction);
	...
	ri.Printf(PRINT_ALL, "GLIMP: Setting fullscreen mode.\n");
...
success:
	...
	ri.Printf(PRINT_ALL, "GLIMP: getting configs.\n");
...
//	Q_strncpyz(glConfig.renderer_string, (char *)glGetString(GL_RENDERER), sizeof(glConfig.renderer_string));
	...
	ri.Printf(PRINT_ALL, "GLIMP: getting extensions.\n");
	...
	ri.Printf(PRINT_ALL, "GLIMP: Done with glimp.\n");
