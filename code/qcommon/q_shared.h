...
#ifdef STANDALONE
  #define PRODUCT_NAME				"planetquake"
  #define BASEGAME					"base"
  #define CLIENT_WINDOW_TITLE		"Planet Quake"
  #define CLIENT_WINDOW_MIN_TITLE	"Planet Quake"
  #define HOMEPATH_NAME_UNIX		".quake"
  #define HOMEPATH_NAME_WIN			"PlanetQuake"
  #define HOMEPATH_NAME_MACOSX		HOMEPATH_NAME_WIN
//  #define STEAMPATH_NAME			"Foo Bar"
//  #define STEAMPATH_APPID         ""
  #define GAMENAME_FOR_MASTER		"base"	// must NOT contain whitespace
