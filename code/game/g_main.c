...
if(world > 0) {
	G_SpawnEntitiesFromString(world, "info_player_start;info_player_deathmatch;item_health_small;item_health_large;misc_portal_surface;misc_portal_camera;misc_teleporter_dest"); //"");
	SaveRegisteredItems();
