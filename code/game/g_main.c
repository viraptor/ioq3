...
if(world > 0) {
	G_SpawnEntitiesFromString(world, "target_speaker;misc_model;info_player_coop;light;trigger_teleport;info_player_start;info_player_deathmatch;item_health_small;item_health_large;misc_portal_surface;misc_portal_camera;misc_teleporter_dest"); //"");
	SaveRegisteredItems();
